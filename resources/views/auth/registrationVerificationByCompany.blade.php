...
<head>
    <meta charset="utf-8" />
    <title>Company Verification | Job Portal</title>
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="p-4 pt-0 my-auto">
                                    <h4 class="fs-20">Company Verification</h4>
                                    <p class="text-muted mb-3">Verification Your Company And Post Job.
                                    </p>
                                    <form method="post" action="{{route('company.verify')}}">
                                        @csrf
                                        <div class="mb-3">
