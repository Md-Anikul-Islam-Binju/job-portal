                        ...
                        <tr>
                            ...
                            <td style="width: 100px;">
                                <div class="d-flex justify-content-end gap-1">
                                    ...
                                    <a href="{{route('admin.service.destroy',$serviceData->id)}}"class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#danger-header-modal{{$serviceData->id}}">Delete</a>
                                </div>
                            </td>
                            <!--Edit Modal -->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="title_bn" name="title_bn" value="{{$serviceData->title_bn}}"
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <img src="{{asset('images/service/'. $serviceData->image )}}" alt="File or  Image" class="mt-2" style="max-width: 50px;">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea id="summernoteEdit{{ $serviceData->id }}" name="details_bn">{{ $serviceData->details_bn }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="d-flex justify-content-end">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{route('admin.service.destroy',$serviceData->id)}}" class="btn btn-danger">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
