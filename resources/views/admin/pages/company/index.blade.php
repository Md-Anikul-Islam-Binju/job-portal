                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            @if($companyData->licence!=null)
                                                            <img src="{{asset('images/licence/'. $companyData->licence )}}" alt="File or  licence" class="mt-2" style="max-width: 50px;">
                                                            @endif
                                                        </div>
                                                    </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{route('admin.company.destroy',$companyData->id)}}" class="btn btn-danger">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <form method="post" action="{{route('admin.company.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="example-fileinput" class="form-label">Trd-Licence</label>
                                    <input type="file" name="licence" id="example-fileinput" class="form-control" required>
                                </div>
                            </div>
