                        ...
                        <tr>
                            ...
                            <td style="width: 100px;">
                                <div class="d-flex justify-content-end gap-1">
                                    ...
                                    <a href="{{route('admin.blog.destroy',$blogData->id)}}"class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#danger-header-modal{{$blogData->id}}">Delete</a>
                                </div>
                            </td>
                            <!--Edit Modal -->
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="{{route('admin.blog.update',$blogData->id)}}" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="row">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="title_bn" name="title_bn" value="{{$blogData->title_bn}}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea id="summernoteEdit{{ $blogData->id }}" name="details_bn">{{ $blogData->details_bn }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="d-flex justify-content-end">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{route('admin.blog.destroy',$blogData->id)}}" class="btn btn-danger">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
