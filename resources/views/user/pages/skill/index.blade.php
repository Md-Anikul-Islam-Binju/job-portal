                        ...
                        <tr>
                            ...
                            <td style="width: 100px;">
                                <div class="d-flex justify-content-end gap-1">
                                    ...
                                    <a href="{{route('user.skill.destroy',$skillData->id)}}"class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#danger-header-modal{{$skillData->id}}">Delete</a>
                                </div>
                            </td>
                            <!--Edit Modal -->
                                ...
                                <div class="modal-dialog  modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="{{route('user.skill.update',$skillData->id)}}" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="row">
                                                    <div class="col-12">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{route('user.skill.destroy',$skillData->id)}}" class="btn btn-danger">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
