                ...
                <div class="col-12">
                    <div class="jobs-card-wrapper">
                        <div class="found-jobs-count-wrap">
                            <h3>{{ locale === 'en' ? 'Training & Workshop' : 'প্রশিক্ষণ ও কর্মশালা' }}</h3>
                            <div class="">
                                <!-- search -->
                    ...
                    <div class="training-card">
                        ...
                        <div class="training-card-content">
                            ...
                            <div class="training-price">
                                ...
                                {{ locale === 'en' ? trainingData.training_fee : trainingData.training_fee }}
                            </div>
                            <div class="register-training">
                                <a href="/user-registration-start"> Register Now </a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            >
                ...
                <div class="right-content">
                    <a href="/user-registration-start">Register as Candidate</a>
                </div>
            </div>
        </div>
    </div>
        ...
        filteredTrainings() {
            ...
            if (this.searchKeyword) {
                filtered = filtered.filter((training) =>
                    training.title.toLowerCase().includes(this.searchKeyword.toLowerCase()) ||
                    (training.title_bn && training.title_bn.toLowerCase().includes(this.searchKeyword.toLowerCase()))
                );
            }
